...
namespace TextSpeedReader
{
    partial class FormTextSpeedReader
    {
        ...
        private void InitializeComponent()
        {
            ...
            contextMenuStrip_treeViewFolder.Size = new Size(389, 148);
            // 
            ...
            Text = "TextSpeedReader Ver. 2.7.1.0  (變更編碼、自動換行、多個AI生圖提示方便編輯功能、優化一簡轉多繁OpenCC.NET，新增批次目錄名稱編碼(亂碼)轉換、檔名編碼(亂碼)轉換、檔名簡轉繁，逐行排序、關鍵字斷行、行首填空)";
