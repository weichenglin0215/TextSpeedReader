    ...
    public partial class FormAIAnalyze : Form
    {
        ...
        private static List<ParamPreset> BuildParamPresets()
        {
            ...
            string[] rows =
            {
                ...
                "LLM大模型參數表-131072-低溫純分析,true,0.4,8192,131072,1.1,40,0.9",
                "LLM大模型參數表-131072-標準,true,0.9,8192,131072,1.1,40,0.9",
                "LLM大模型參數表-131072-熱情,true,1.2,8192,131072,1.1,80,1",
                "LLM大模型參數表-262144-低溫純分析,true,0.4,16384,262144,1.1,40,0.9",
                "LLM大模型參數表-262144-標準,true,0.9,16384,262144,1.1,40,0.9",
                "LLM大模型參數表-262144-熱情,true,1.2,16384,262144,1.1,80,1",
                "LLM大模型參數表-524288-低溫純分析,true,0.4,16384,524288,1.1,40,0.9",
                "LLM大模型參數表-524288-標準,true,0.9,16384,524288,1.1,40,0.9",
                "LLM大模型參數表-524288-熱情,true,1.2,16384,524288,1.1,80,1",
                "LLM大模型參數表-1048576-低溫純分析,true,0.4,16384,1048576,1.1,40,0.9",
                "LLM大模型參數表-1048576-標準,true,0.9,16384,1048576,1.1,40,0.9",
                "LLM大模型參數表-1048576-熱情,true,1.2,16384,1048576,1.1,80,1"
            };
